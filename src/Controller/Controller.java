    ...
    public void groceryPage(){
        ...
        switch (choice) {
            case 1: 
                ...
                break;
            case 2:
                product.showProducts("Refrigerator");
                 order.orderProduct("Refrigerator");
                break;
            case 3:
                product.showProducts("Fan");
                   order.orderProduct("Fan");  
                break;
            case 4:
                product.showProducts("HeadPhone");
                  order.orderProduct("HeadPhone");
                break;
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3:
                product.showProducts("Golf");
                   order.orderProduct("Golf");  
                break;
            case 4:
        ...
        switch (choice) {
            case 1: 
                product.showProducts("CosmeticsMan");
                order.orderProduct("CosmeticsMan");
                break;
            case 2:
                product.showProducts("CosmeticsWomen");
                 order.orderProduct("CosmeticsWomen");
                break;
        ...
        switch (choice) {
            case 1: 
                product.showProducts("ChattelPaper");
                order.orderProduct("ChattelPaper");
                break;
            case 2:
                product.showProducts("Instruments");
                 order.orderProduct("Instruments");
                break;
